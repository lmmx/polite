...
pub enum ConnectorXOutError {
    ...
    #[error(transparent)]
    SQLiteSourceError(#[from] crate::connectorx::sources::sqlite::SQLiteSourceError),
    ...
    #[error(transparent)]
    ArrowError(#[from] crate::connectorx::destinations::arrow::ArrowDestinationError),

    // #[cfg(feature = "dst_arrow")]
    #[error(transparent)]
    ArrowStreamError(#[from] crate::connectorx::destinations::arrowstream::ArrowDestinationError),

    // #[cfg(all(feature = "src_sqlite", feature = "dst_arrow"))]
    #[error(transparent)]
    SQLiteArrowTransportError(#[from] crate::connectorx::transports::SQLiteArrowTransportError),
